...
class AgentBoundaryTest {
  ...
  @Test void acceptsOnlyGithubSshRepositorySyntax(){assertTrue(boundary.accepts(new AgentBoundary.Manifest("1","2","3","git@github.com:west6ide/qmeet.git","main","abcdef1","DOCKERFILE",3000,0,"/","autodeploy/demo:abcdef1",Instant.now().plusSeconds(60),false)));assertFalse(boundary.accepts(new AgentBoundary.Manifest("1","2","3","git@evil.example:west6ide/qmeet.git","main","abcdef1","DOCKERFILE",3000,0,"/","autodeploy/demo:abcdef1",Instant.now().plusSeconds(60),false)));}
